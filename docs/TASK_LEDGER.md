...
| P8-09 | Audit cleanup for brand-token consistency, readability, and spacing | Codex | DONE | `app/globals.css`, `app/banquet/components/BanquetHero.jsx`, `app/banquet/components/BanquetOfferings.jsx`, `app/banquet/components/BanquetPackages.jsx`, `app/banquet/components/BanquetGallery.jsx`, `app/kitty-parties/components/KittyHero.jsx`, `app/kitty-parties/components/KittyOfferings.jsx`, `app/kitty-parties/components/KittyPackages.jsx`, `components/shared/PlaceholderImage.jsx`, `components/shared/WhatsAppFloat.jsx`, `components/shared/ContactActions.jsx`, `components/shared/BookingPlatforms.jsx`, `components/sections/MenuHighlights.jsx`, `components/sections/TestimonialsCarousel.jsx`, `components/sections/ExperiencesStrip.jsx`, `components/sections/CuisineCards.jsx`, `components/sections/StoryValues.jsx` | Replaced remaining audited non-brand blue, purple, green, orange, rose, and gray utility colours with brand-token surfaces; added stable root font-variable fallbacks; improved placeholder contrast; and removed the fixed dining-card minimum height that was creating uneven spacing |
